...
0 && (module.exports = {
    addConfiguredExperimentalFeature: null,
    default: null,
...
_export(exports, {
    addConfiguredExperimentalFeature: function() {
        return addConfiguredExperimentalFeature;
    },
    default: function() {
        return loadConfig;
    },
...
function assignDefaults(dir, userConfig, silent) {
    ...
    if ((_defaultConfig_experimental1 = _configshared.defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental1.dynamicIO) {
        _log.warn(`\`experimental.dynamicIO\` has been defaulted to \`true\` because \`__NEXT_EXPERIMENTAL_CACHE_COMPONENTS\` was set to \`true\` during testing.`);
    }
    const result = {
    ...
    if (result.experimental) {
        ...
        result.experimental.cacheLife = {
            ...(_defaultConfig_experimental2 = _configshared.defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental2.cacheLife,
            ...result.experimental.cacheLife
        };
        const defaultDefault = (_defaultConfig_experimental3 = _configshared.defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_cacheLife = _defaultConfig_experimental3.cacheLife) == null ? void 0 : _defaultConfig_experimental_cacheLife['default'];
        if (!defaultDefault || defaultDefault.revalidate === undefined || defaultDefault.expire === undefined || !((_defaultConfig_experimental4 = _configshared.defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes = _defaultConfig_experimental4.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes.static)) {
        ...
        if (!defaultCacheLifeProfile) {
            ...
            if (defaultCacheLifeProfile.stale === undefined) {
                ...
                defaultCacheLifeProfile.stale = staticStaleTime ?? ((_defaultConfig_experimental5 = _configshared.defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes1 = _defaultConfig_experimental5.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes1.static);
            }
        ...
        if (secondsCacheLifeProfile && secondsCacheLifeProfile.stale === undefined) {
            ...
            secondsCacheLifeProfile.stale = dynamicStaleTime ?? ((_defaultConfig_experimental6 = _configshared.defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes2 = _defaultConfig_experimental6.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes2.dynamic);
        }
    }
